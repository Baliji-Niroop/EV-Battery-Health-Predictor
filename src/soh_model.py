...
# Fixed feature columns for model consistency
FEATURE_COLS = [
    "voltage_mean",
    "current_mean",
    "temp_mean",
...
def main() -> None:
    ...
    # We use FEATURE_COLS to ensure consistency.
    ...
    unique_batteries = list(df["battery_id"].unique())
    ...
    try:
        ...
        print(f"[ERROR] Failed to save model or schema: {exc}")
